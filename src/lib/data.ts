...
export const SITE = {
  ...
  bio: [
    "I'm a full-stack developer who builds mobile and web applications from the ground up — from planning and design to a live product in people's hands.",
    "Since 2023, I've led E.M.P.O.W.E.R, an offline-first Flutter application built for DSWD's Sustainable Livelihood Program associations — community-run micro-enterprises that often operate with little to no internet access. Over the past three years I've led a nine-person team building its inventory, sales, and financial modules, designed a self-contained offline license-activation system so associations never need a live server, and led the migration of our codebase to a clean, governed repository as the team scaled.",
    "Outside of that, I build to learn: SneakerGrit is a full e-commerce storefront I built with vanilla JavaScript and a live Supabase backend, fully functional end-to-end from browsing to checkout. PisoGen was a coin-operated phone-rental kiosk platform I ran as my own small business, spanning a Flutter kiosk app and two React dashboards backed by a Django/Supabase API. I'm currently studying at Cebu Technological University — Ginatilan Extension Campus, and I'm always looking for the next problem worth solving.",
  ],
} as const;
